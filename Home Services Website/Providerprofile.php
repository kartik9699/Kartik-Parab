...
<?php include "./provider/header.php"; 
?>
<body>
...
$sql10="UPDATE `provider` SET `Provider_Name` = '$username', `Adress` = '$useradress', `City` = '$city', `Contact` = $userphone, `Email` = '$useremail', `PinCode` = $Pincode WHERE Provider_ID = $sid2";
...
$conpass=$_POST['conpass'];
    $sql001="select * from provider where Provider_ID = $sid2";
    $res=mysqli_query($conn,$sql001);
    if($res->num_rows>0){
        $data=$res->fetch_assoc();
        if($data['Password']===$currpass){
          if($newpass===$conpass){
          $sql002="UPDATE `customer` SET Password='$newpass' WHERE Provider_ID = $sid2";
...
?>     
      <?php
          $sql5 = "SELECT  * FROM provider WHERE Provider_ID =$sid2";
                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <h6 class="f-w-600 text-dark"><?php echo $rec2['Provider_Name'];?></h6>
                                                                <p class="f-w-600 text-dark"><?php echo $rec2['Adress'];?></p>
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400"><?php echo $rec2['Email'];?></h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Phone</p>
                                                                        <h6 class="text-muted f-w-400"><?php echo $rec2['Contact'];?></h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">City</p>
                                                                        <h6 class="text-muted f-w-400"><?php echo $rec2['City'];?></h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Pincode</p>
                                                                        <h6 class="text-muted f-w-400"><?php echo $rec2['PinCode'];?></h6>
                                                                    </div>
                                                            </div><div class="">
      ...
      <div class="modal-body">
        <form name="myform" onsubmit="return myscript()" method="post" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" value="<?php echo $rec2['Provider_Name'];?>" pattern="[A-Za-z\s]{3,}"  required="">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Email:</label>
            <input type="email" class="form-control" id="email" name="email" value="<?php echo $rec2['Email'];?> " required="">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">phone no:</label>
            <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $rec2['Contact'];?>" pattern="[0-9]{10}" required="">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Address:</label>
            <input type="text" class="form-control" id="adress" name="adress" value="<?php echo $rec2['Adress'];?>" required="">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">City:</label>
            <input type="text" class="form-control" id="City" name="City" value="<?php echo $rec2['City'];?>" required="">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Pincode:</label>
            <input type="text" class="form-control" id="Pincode" name="Pincode" value="<?php echo $rec2['PinCode'];?>" required="">
          </div>
